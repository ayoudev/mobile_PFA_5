...
class _ScanPageState extends State<ScanPage> {
  ...
  final ImagePicker _picker = ImagePicker(); // Instance pour sélectionner des fichiers
  ...
  Future<void> _startScan() async {
    ...
    if (status.isGranted) {
      ...
      setState(() {
        _pictures = ['Permission caméra refusée. Veuillez l\'activer dans les paramètres.'];
      });
    }
  }
